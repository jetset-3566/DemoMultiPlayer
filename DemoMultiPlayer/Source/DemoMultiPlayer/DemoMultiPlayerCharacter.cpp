...
#include "DemoMultiPlayerProjectile.h"
...
void ADemoMultiPlayerCharacter::OnFire()
{
	...
	//			//World->SpawnActor<ADemoMultiPlayerProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
	//		}
	//		else
	//		{
	...
	//			World->SpawnActor<ADemoMultiPlayerProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
	//		}
	//	}
	//}
...
//void ADemoMultiPlayerCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool ADemoMultiPlayerCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	...
	{
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ADemoMultiPlayerCharacter::BeginTouch);
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ADemoMultiPlayerCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &ADemoMultiPlayerCharacter::TouchUpdate);
		return true;
	}
